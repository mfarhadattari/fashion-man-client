      ...
      {isLoading ? (
        ...
        <>
          <section className="grid  grid-cols-1 md:grid-cols-2 my-10">
            <div>
              <LineChartComponent
                data={adminOverview.paymentInfo}
                dataKeyY="totalAmount"
                dataKeyX="month"
              />
              <p className="text-center text-xl font-medium">Monthly Payments</p>
            </div>
            <div>
              <LineChartComponent
                data={adminOverview.OrderInfo}
                dataKeyY="count"
                dataKeyX="month"
              />
              <p className="text-center text-xl font-medium">Monthly Orders</p>
            </div>
          </section>
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-10 justify-center mt-10">
              <div className="flex justify-center gap-10 items-end border rounded-md shadow-lg p-5 hover:border-slate-900 ">
                <div className="font-bold">
